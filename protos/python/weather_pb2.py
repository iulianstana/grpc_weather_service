...
_WEATHERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='country', full_name='weather.WeatherRequest.country', index=1,
...
_WEATHERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Get',
    full_name='weather.WeatherService.Get',
    index=0,
...
try:
  ...
  class WeatherServiceStub(object):
    ...
    def __init__(self, channel):
      ...
      self.Get = channel.unary_unary(
          ...
          request_serializer=WeatherRequest.SerializeToString,
          response_deserializer=WeatherResponse.FromString,
          )
  ...
  def add_WeatherServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'Get': grpc.unary_unary_rpc_method_handler(
            servicer.Get,
            request_deserializer=WeatherRequest.FromString,
            response_serializer=WeatherResponse.SerializeToString,
        ),
    }
  ...
  def beta_create_WeatherService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('weather.WeatherService', 'Get'): WeatherRequest.FromString,
    }
    response_serializers = {
      ('weather.WeatherService', 'Get'): WeatherResponse.SerializeToString,
    }
    method_implementations = {
      ('weather.WeatherService', 'Get'): face_utilities.unary_unary_inline(servicer.Get),
    }
  ...
  def beta_create_WeatherService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('weather.WeatherService', 'Get'): WeatherRequest.SerializeToString,
    }
    response_deserializers = {
      ('weather.WeatherService', 'Get'): WeatherResponse.FromString,
    }
    cardinalities = {
      'Get': cardinality.Cardinality.UNARY_UNARY,
    }
    stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer, request_serializers=request_serializers, response_deserializers=response_deserializers, thread_pool=pool, thread_pool_size=pool_size)
    return beta_implementations.dynamic_stub(channel, 'weather.WeatherService', cardinalities, options=stub_options)
except ImportError:
  pass
